    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group"  style="display:flex; flex-direction: row;">
	        	<label for="brandName" class="col-sm-3 control-label" style="padding-left: 30px">Brand Name: </label>
	        	<label class="col-sm-1 control-label">: </label>
...
<!-- / add modal -->
	        ...
	        <div class="form-group" style="display:flex; flex-direction: row;">
	        	<label for="categoryName" class="col-sm-3 control-label" style="padding-left: 30px">Category Name: </label>
				<label class="col-sm-1 control-label">: </label>
					<div class="col-sm-8">
			    ...
			    <label class="col-sm-1 control-label"></label>
					<div class="col-sm-8">
						<div>
							<button class="btn btn-default button1" data-toggle="modal" id="addCategoriesModalBtn" data-target="#addCategoriesModal"> <i class="glyphicon glyphicon-plus-sign"></i> Add Categories </button></a>
		                </div>
		            </div>	
		    </div><!-- /form-group-->				        	         	       
